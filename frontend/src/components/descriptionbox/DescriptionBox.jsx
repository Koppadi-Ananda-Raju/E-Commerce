    ...
    <div className='descriptionbox'>
        ...
        <div className="descriptionbox-description">
            <p>An e-commerce website is an online platform that facilitate the
                ...
                <p>E-commerce websites typically display products or serivces along with detailed descriptions, images, prices, and any available variations (e.g. sizes, colors). Each product usually has its own dedicated page with relevant information</p>
        </div>
    </div>
  )
}
